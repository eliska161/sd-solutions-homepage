...
export function SoftwareIllustration() {
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 top-1/2 h-[70%] w-[70%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/[0.07] blur-3xl" />
          ...
          <div className="col-span-9 space-y-3">
            <div className="h-16 rounded-lg border border-border bg-background/30 p-3">
              <div className="flex items-center justify-between">
                ...
                <div className="h-5 w-14 rounded-md bg-primary/20" />
              </div>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary/15">
            <div className="h-3.5 w-3.5 rounded-[3px] border-2 border-primary/70" />
          </div>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="h-5 rounded-md border border-border px-2">
            <div className="mt-[7px] h-1 w-6 rounded-full bg-primary/40" />
          </div>
        </div>
