...
export const flipCandidates = pgTable("flip_candidates", {
  ...
  estimatedInvestmentOre: integer("estimated_investment_ore").notNull().default(0),
...
export const refurbishments = pgTable("refurbishments", {
  ...
  activationLockClear: boolean("activation_lock_clear").notNull().default(false),
