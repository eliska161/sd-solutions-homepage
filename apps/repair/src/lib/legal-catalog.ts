...
export const PART_GRADE_CUSTOMER_TEXT =
  "Du velger selv hvilken del vi skal sette i, og prisen avhenger av det. For skjerm er kopi Soft OLED, for batteri kopi premium. Du kan også velge original del tatt ut av en annen telefon (batteri bare med 99–100 % helse), eller helt ny original del. Ikke alle typer finnes til alle modeller. Hva som monteres, står på saken.";
